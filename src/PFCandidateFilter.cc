...
class PFCandidateFilter : public EDProducer 
{
public: 
  explicit PFCandidateFilter(const ParameterSet&);
  ~PFCandidateFilter();
...
PFCandidateFilter::PFCandidateFilter(const ParameterSet& iConfig)
...
bool PFCandidateFilter::produce(Event& event, const EventSetup& eventSetup) {
...
void PFCandidateFilter::beginRun(edm::Run & iRun, edm::EventSetup const & iSetup){
...
void PFCandidateFilter::endRun(edm::Run&, edm::EventSetup const&) {

}

void PFCandidateFilter::beginLuminosityBlock(edm::LuminosityBlock&, edm::EventSetup const&) {

}

void PFCandidateFilter::endLuminosityBlock(edm::LuminosityBlock&, edm::EventSetup const&) {

}

bool PFCandidateFilter::triggerFired(const std::string& triggerWildCard, const edm::TriggerResults& triggerResults) {
  bool fired = false;
...
unsigned int PFCandidateFilter::findTrigger(const std::string& triggerWildCard) {
